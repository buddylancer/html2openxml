    ...
    public class LinkTests : HtmlConverterTestBase
    {
        ...
        public void ParseLink()
        {
            ...
            Assert.Multiple(() => {
				...
				Assert.That(elements[0].FirstChild, Is.TypeOf(typeof(OxW.Hyperlink)));
				Assert.That(elements[0].FirstChild.FirstChild, Is.TypeOf(typeof(OxW.Run)));
                Assert.That(elements[0].InnerText, Is.EqualTo("Test Caption"));
            });

			var hyperlink = (OxW.Hyperlink)elements[0].FirstChild;
        ...
        public void ParseInvalidLink (string html)
        {
            ...
            Assert.Multiple(() => {
				Assert.That(elements[0], Is.TypeOf(typeof(OxW.Paragraph)));
				Assert.That(elements[0].FirstChild, Is.TypeOf(typeof(OxW.Run)));
				Assert.That(elements[0].FirstChild.FirstChild, Is.TypeOf(typeof(OxW.Text)));
            });
        }
        ...
        public void ParseTextImageLink ()
        {
			...
			Assert.That(hyperlink.FirstChild, Is.TypeOf(typeof(OxW.Run)));
			Assert.That(hyperlink.FirstChild.FirstChild, Is.TypeOf(typeof(OxW.Drawing)));
        ...
        public void ParseAnchorLink ()
        {
			...
			hyperlink = (OxW.Hyperlink)elements[0].FirstChild;
